...
- **Offline-first**: keep a local replica of your remote collections and read, edit, flag, move and delete fully offline.
...
See documentation at [docs.rs](https://docs.rs/io-replica/latest/io_replica).
