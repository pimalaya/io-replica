...
/// collection stays correct. Under-delivering does not: a mutation that
/// cannot see a colliding link id creates a duplicate.
...
pub enum ReplicaLoadScope {
    ...
    /// that is: a read asking about an identity rather than a location
    /// has to see every row claiming it.
